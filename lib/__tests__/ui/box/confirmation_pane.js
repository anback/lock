...
var defaultProps = {
  ...
  children: _react2.default.createElement('span', null, 'test'),
  svg: _react2.default.createElement('svg', null, 'svg')
};
              ...
              switch ((_context.prev = _context.next)) {
                case 0:
                  (0, _testUtils.expectComponent)(
                    _react2.default.createElement(_confirmation_pane2.default, defaultProps)
                  ).toMatchSnapshot();
